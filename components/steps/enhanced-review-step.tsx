...
import { Form1040Preview } from "@/components/form-1040-preview"
import { Form1040Actions } from "@/components/form-1040-actions"
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-6">
        <Alert>
          ...
          <AlertDescription>
            Your tax return is ready for review. You can now preview and download your official Form 1040.
          </AlertDescription>
        </Alert>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="form1040" className="flex items-center space-x-2">
          ...
          <TabsContent value="form1040" className="mt-6">
            {/* Form 1040 Actions */}
            <div className="mb-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  <span>Form 1040 - Official Tax Return</span>
                  <Form1040Preview taxReturn={taxReturn} />
                </CardTitle>
                <CardDescription>
                  This is your official IRS Form 1040 ready for download and filing.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div data-form-1040 className="transform scale-50 origin-top-left overflow-hidden max-h-96">
                    <div className="bg-white p-8 shadow-sm">
                      ...
                      <div className="space-y-4 text-sm">
                        <div className="flex justify-between">
                          <span>Name: {taxReturn.firstName} {taxReturn.lastName}</span>
                          <span>Filing Status: {taxReturn.filingStatus.replace(/_/g, ' ')}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Total Income: ${Number(taxReturn.totalIncome).toLocaleString()}</span>
                          <span>Taxable Income: ${Number(taxReturn.taxableIncome).toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between font-bold">
                  ...
                  <div className="mt-4 text-center">
                    <p className="text-sm text-gray-600">
                      Preview of your Form 1040. Click "Preview Form 1040" above to see the full form.
                    </p>
                  </div>
                </div>
              </CardContent>
