...
import { Send, ArrowLeft, CheckCircle, FileText, Shield, Clock, Download, Eye } from "lucide-react"
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Download Your Form 1040</span>
              </CardTitle>
              <CardDescription>
                Your official IRS Form 1040 is ready for download
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-gray-600">
                  Keep a copy of your completed Form 1040 for your records. You can download it as a PDF or view the preview.
                </p>
                  ...
                  <Form1040Preview 
                    ...
                    trigger={
                      <Button variant="outline" className="flex items-center space-x-2">
                        ...
                        <span>View Form 1040</span>
                      </Button>
                    }
                  />
                  <div className="flex-1">
                    <div data-form-1040 className="hidden">
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Download your completed Form 1040 before filing
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  We recommend downloading your Form 1040 before filing for your records.
                </AlertDescription>
              </Alert>
